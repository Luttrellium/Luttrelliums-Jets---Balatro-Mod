...
SMODS.Joker {
    ...
    calculate = function(self, card, context)
        if context.retrigger_joker_check and context.other_card ~= card and context.other_card.ability.extra and type(context.other_card.ability.extra) == 'table' and context.other_card.ability.extra.is_jet_joker and not (context.other_card.ability.name == 'SUPCruise' and context.other_context.end_of_round) then
            return {
                repetitions = 1,
                message = "Refuelled!",
            }
